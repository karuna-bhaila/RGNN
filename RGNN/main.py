...
def get_arguments():
    ...
    parser.add_argument('--cols_to_group', type=int, default=70,
    ...
    # Privacy
    parser.add_argument('--x_eps', type=float, default=1,
    ...
    parser.add_argument('--y_eps', type=float, default=1,
                        help='Privacy budget for node labels')

    # Reconstruction and LLP
    parser.add_argument('--xhops', type=int, default=16,
                        help='Hops for fx')
